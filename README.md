...
class GeershatiSaxena:
    ...
    location   = "India 🇮🇳"
    focus      = ["Machine Learning", "Deep Learning", "AI-Powered Apps"]
    interests  = ["UI/UX Design", "Open Source", "Anime", "Music"]
    currently  = "Levelling up in Deep Learning & interactive dashboards"
    motto      = "Transforming data into intelligence, one line of code at a time."
```
